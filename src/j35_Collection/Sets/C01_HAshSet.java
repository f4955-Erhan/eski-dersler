...
public class C01_HAshSet {
     ...
     */
        ...
        HashSet<String> hs1= new HashSet<>();//boş bir Hash set
        //set print etme
        ...
        System.out.println("hs1 = " + hs1); // 3 adet null ekledik fakat 1 adet ve başa yazdı

        HashSet<String> hs2= new HashSet<>(Arrays.asList("erhan","kemal","cemal","nöri"));
        ...
        System.out.println("hs1.remove(\"nöri\") = " + hs1.remove("nöri"));//true
        System.out.println("hs1.remove(\"Erhan\") = " + hs1.remove("Erhan"));//false

        System.out.println("hs1 = " + hs1);//nöri silindi
        ...
        System.out.println("hs2.contains(\"cemal\") = " + hs2.contains("cemal"));
