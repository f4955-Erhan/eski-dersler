...
public class C01_LambdaExpression {
	 ...
	 */
        ...
        prinElemanStructuredProgram(sayilar);
        System.out.println();
        prinElFunctional(sayilar);
        System.out.println();
        prinElFunctional1(sayilar);
        System.out.println();
        prinElFunctional2(sayilar);


    }//main sonu

    private static void prinElemanStructuredProgram(List<Integer> sayilar) {
    ...
    public static void prinElFunctional(List<Integer> sayilar) {
    ...
    */
    ...
    public static void prinElFunctional1(List<Integer> sayilar) {

        sayilar.//aksiyona girecek list call
                stream().//List elemanlarını yukarıdan aşağıya akışa alır
                forEach( System.out::print);//method reference -> system.out yapısında print method call edildi
                                                // method kaynağı :: Method -> method reference

    }

    public static void yazdır(int a){//refere edilecek method
        System.out.print(a+" ");

    }


    public static void prinElFunctional2(List<Integer> sayilar) {

        sayilar.//aksiyona girecek list call
                stream().//List elemanlarını yukarıdan aşağıya akışa alır
                forEach( C01_LambdaExpression::yazdır);//method reference -> system.out yapısında print method call edildi
        // method kaynağı :: Method -> method reference
    ...
    public static boolean otuzBeşdenKucuk(int X) {//Refere edilecek method
        return X<35 ;
    }
