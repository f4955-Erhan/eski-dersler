...
public class C01_AccessModifier {
    ...
    int defaultYas = 24;// acces Modifier yazılmazsa default tanımlanır.
    protected int protectedYas = 24;
    public int publicYas = 24;


    private C01_AccessModifier() {// private constructor
        System.out.println("agama private");
    }

    public C01_AccessModifier(int privateYas, int defaultYas) {// public 2 p li constructor
    ...
    private void privateMethod(){
        ...
        System.out.println("privateMethod dan selamlar...");
    }

    protected  void protectedMethod(){
        System.out.println("protectedMethod dan selamlar...");
